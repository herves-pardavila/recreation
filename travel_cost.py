...
if __name__== "__main__":
    ...
    bad_index=df[(df.turistas.isin([" ","."]) )].index
    ...
    print(df.info())
    #remove nans
    df=df[["Date","origen","turistas","distance","Poblacion","Season","covid"]]
    df.dropna(subset=["origen","turistas","distance","Poblacion"],inplace=True)

...
if __name__== "__main__":
    ...
    #load the data
    df=pd.read_csv("travel_cost_manzaneda.csv")
    print(df)
#     remove nans
...
#     print("AIC=",nb2_training_results.aic)
    ...
    print("Consumer Surplus=",-1*df_train.y.mean()/(nb2_training_results.params[1]))
    print("Consumer Surplus Lineal =",-1/nb2_training_results.params[1])

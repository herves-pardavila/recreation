...
if __name__== "__main__":
    ...
    ax2["A"].loglog(newdfA.Visitantes,newdfA.yhatmodel1,"o",color="pink",label="Flickr")
    ax2["A"].loglog(newdfA.Visitantes,newdfA.yhatmodel2,"o",color="red",label="Phones")
    ax2["A"].loglog(newdfA.Visitantes,newdfA.yhatmodel4,"o",color="blue",label="Flickr+Instagram")
    ax2["A"].loglog(newdfA.Visitantes,newdfA.yhatmodel5,"o",color="black",label="Flickr+Phones")
    ...
    ax2["A"].text(0.75,0.35,str(newdfA.R2dev1model1.min()),transform=ax2["A"].transAxes,color="pink",fontsize=12)
    ax2["A"].text(0.75,0.25,str(newdfA.R2dev1model2.min()),transform=ax2["A"].transAxes,color="red",fontsize=12)
    #ax2["A"].text(0.75,0.15,str(newdfA.R2devmodel4.min()),transform=ax2["A"].transAxes,color="blue",fontsize=12)
    ax2["A"].text(0.75,0.05,str(newdfA.R2dev1model5.min()),transform=ax2["A"].transAxes,color="black",fontsize=12)
    ax2["A"].text(0.85,0.35,"("+str(newdfA.R2dev2model1.min())+")",transform=ax2["A"].transAxes,color="pink",fontsize=12)
    ax2["A"].text(0.85,0.25,"(" + str(newdfA.R2dev2model2.min())+")",transform=ax2["A"].transAxes,color="red",fontsize=12)
    #ax2["A"].text(0.85,0.15,"("+str(newdfA.R2dev2model4.min())+")",transform=ax2["A"].transAxes,color="blue",fontsize=12)
    ax2["A"].text(0.85,0.05,"("+str(newdfA.R2dev2model5.min())+")",transform=ax2["A"].transAxes,color="black",fontsize=12)

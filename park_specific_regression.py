...
if __name__== "__main__":
    ...
    ax2["A"].text(0.75,0.35,str(newdfA.R2devmodel1.min()),transform=ax2["A"].transAxes,color="pink",fontsize=12)
    ax2["A"].text(0.75,0.25,str(newdfA.R2devmodel2.min()),transform=ax2["A"].transAxes,color="red",fontsize=12)
    #ax2["A"].text(0.75,0.15,str(newdfA.R2devmodel4.min()),transform=ax2["A"].transAxes,color="blue",fontsize=12)
    ax2["A"].text(0.75,0.05,str(newdfA.R2devmodel5.min()),transform=ax2["A"].transAxes,color="black",fontsize=12)

...
if __name__== "__main__":
    ...
    df2=df.dropna(subset=["Visitantes","turistas_total"])
    ...
    df5=df.dropna(subset=["Visitantes","turistas_total","PUD"])
    ...
    fig2.subplots_adjust(hspace=0.35,left=0.075,right=0.95, top=0.9, bottom=0.075)
    fig2.text(x=0.45,y=0.025,s="Measured Visitors",fontsize=20)
    fig2.text(x=0.025,y=0.45,s="Expected Visitors",rotation="vertical",fontsize=20)
    ...
    ax2["A"].title.set_text(newdfA.IdOAPN.unique()[0])
    ax2["A"].text(0.8,0.35,str(mean_absolute_percentage_error(newdfA.Visitantes,newdfA.yhatmodel1)),transform=ax2["A"].transAxes,color="pink",fontsize=15)
    ax2["A"].text(0.8,0.25,str(newdfA.R2devmodel2.min()),transform=ax2["A"].transAxes,color="red",fontsize=15)
    ax2["A"].text(0.8,0.15,str(newdfA.R2devmodel4.min()),transform=ax2["A"].transAxes,color="blue",fontsize=15)
    ax2["A"].text(0.8,0.05,str(newdfA.R2devmodel5.min()),transform=ax2["A"].transAxes,color="black",fontsize=15)
    ...
    ax2["B"].title.set_text(newdfB.IdOAPN.unique()[0])
    ax2["B"].text(0.8,0.35,str(newdfB.R2devmodel1.min()),transform=ax2["B"].transAxes,color="pink",fontsize=15)
    ax2["B"].text(0.8,0.25,str(newdfB.R2devmodel2.min()),transform=ax2["B"].transAxes,color="red",fontsize=15)
    ax2["B"].text(0.8,0.15,str(newdfB.R2devmodel4.min()),transform=ax2["B"].transAxes,color="blue",fontsize=15)
    ax2["B"].text(0.8,0.05,str(newdfB.R2devmodel5.min()),transform=ax2["B"].transAxes,color="black",fontsize=15)
    ...
    ax2["C"].title.set_text(newdfC.IdOAPN.unique()[0])
    ax2["C"].text(0.8,0.35,str(newdfC.R2devmodel1.min()),transform=ax2["C"].transAxes,color="pink",fontsize=15)
    ax2["C"].text(0.8,0.25,str(newdfC.R2devmodel2.min()),transform=ax2["C"].transAxes,color="red",fontsize=15)
    ax2["C"].text(0.8,0.15,str(newdfC.R2devmodel4.min()),transform=ax2["C"].transAxes,color="blue",fontsize=15)
    ax2["C"].text(0.8,0.05,str(newdfC.R2devmodel5.min()),transform=ax2["C"].transAxes,color="black",fontsize=15)
    ...
    ax2["D"].title.set_text(newdfD.IdOAPN.unique()[0])
    ax2["D"].text(0.8,0.35,str(newdfD.R2devmodel1.min()),transform=ax2["D"].transAxes,color="pink",fontsize=15)
    ax2["D"].text(0.8,0.25,str(newdfD.R2devmodel2.min()),transform=ax2["D"].transAxes,color="red",fontsize=15)
    ax2["D"].text(0.8,0.15,str(newdfD.R2devmodel4.min()),transform=ax2["D"].transAxes,color="blue",fontsize=15)
    ax2["D"].text(0.8,0.05,str(newdfD.R2devmodel5.min()),transform=ax2["D"].transAxes,color="black",fontsize=15)
    ...
    ax2["E"].title.set_text(newdfE.IdOAPN.unique()[0])
    ax2["E"].text(0.8,0.35,str(newdfE.R2devmodel1.min()),transform=ax2["E"].transAxes,color="pink",fontsize=15)
    ax2["E"].text(0.8,0.25,str(newdfE.R2devmodel2.min()),transform=ax2["E"].transAxes,color="red",fontsize=15)
    ax2["E"].text(0.8,0.15,str(newdfE.R2devmodel4.min()),transform=ax2["E"].transAxes,color="blue",fontsize=15)
    ax2["E"].text(0.8,0.05,str(newdfE.R2devmodel5.min()),transform=ax2["E"].transAxes,color="black",fontsize=15)
    ...
    ax2["F"].title.set_text(newdfF.IdOAPN.unique()[0])
    ax2["F"].text(0.8,0.35,str(newdfF.R2devmodel1.min()),transform=ax2["F"].transAxes,color="pink",fontsize=15)
    ax2["F"].text(0.8,0.25,str(newdfF.R2devmodel2.min()),transform=ax2["F"].transAxes,color="red",fontsize=15)
    ax2["F"].text(0.8,0.15,str(newdfF.R2devmodel4.min()),transform=ax2["F"].transAxes,color="blue",fontsize=15)
    ax2["F"].text(0.8,0.05,str(newdfF.R2devmodel5.min()),transform=ax2["F"].transAxes,color="black",fontsize=15)
    ...
    ax2["G"].title.set_text(newdfG.IdOAPN.unique()[0])
    ax2["G"].text(0.8,0.35,str(newdfG.R2devmodel1.min()),transform=ax2["G"].transAxes,color="pink",fontsize=15)
    ax2["G"].text(0.8,0.25,str(newdfG.R2devmodel2.min()),transform=ax2["G"].transAxes,color="red",fontsize=15)
    ax2["G"].text(0.8,0.15,str(newdfG.R2devmodel4.min()),transform=ax2["G"].transAxes,color="blue",fontsize=15)
    ax2["G"].text(0.8,0.05,str(newdfG.R2devmodel5.min()),transform=ax2["G"].transAxes,color="black",fontsize=15)
    ...
    ax2["H"].title.set_text(newdfH.IdOAPN.unique()[0])
    ax2["H"].text(0.8,0.35,str(newdfH.R2devmodel1.min()),transform=ax2["H"].transAxes,color="pink",fontsize=15)
    ax2["H"].text(0.8,0.25,str(newdfH.R2devmodel2.min()),transform=ax2["H"].transAxes,color="red",fontsize=15)
    ax2["H"].text(0.8,0.15,str(newdfH.R2devmodel4.min()),transform=ax2["H"].transAxes,color="blue",fontsize=15)
    ax2["H"].text(0.8,0.05,str(newdfH.R2devmodel5.min()),transform=ax2["H"].transAxes,color="black",fontsize=15)
    ...
    ax2["I"].title.set_text(newdfI.IdOAPN.unique()[0])
    ax2["I"].text(0.8,0.35,str(newdfI.R2devmodel1.min()),transform=ax2["I"].transAxes,color="pink",fontsize=15)
    ax2["I"].text(0.8,0.25,str(newdfI.R2devmodel2.min()),transform=ax2["I"].transAxes,color="red",fontsize=15)
    ax2["I"].text(0.8,0.15,str(newdfI.R2devmodel4.min()),transform=ax2["I"].transAxes,color="blue",fontsize=15)
    ax2["I"].text(0.8,0.05,str(newdfI.R2devmodel5.min()),transform=ax2["I"].transAxes,color="black",fontsize=15)
    ...
    ax2["J"].title.set_text(newdfJ.IdOAPN.unique()[0])
    ax2["J"].text(0.8,0.35,str(newdfJ.R2devmodel1.min()),transform=ax2["J"].transAxes,color="pink",fontsize=15)
    ax2["J"].text(0.8,0.25,str(newdfJ.R2devmodel2.min()),transform=ax2["J"].transAxes,color="red",fontsize=15)
    ax2["J"].text(0.8,0.15,str(newdfJ.R2devmodel4.min()),transform=ax2["J"].transAxes,color="blue",fontsize=15)
    ax2["J"].text(0.8,0.05,str(newdfJ.R2devmodel5.min()),transform=ax2["J"].transAxes,color="black",fontsize=15)
    ...
    ax2["K"].title.set_text(newdfK.IdOAPN.unique()[0])
    ax2["K"].text(0.8,0.35,str(newdfK.R2devmodel1.min()),transform=ax2["K"].transAxes,color="pink",fontsize=15)
    ax2["K"].text(0.8,0.25,str(newdfK.R2devmodel2.min()),transform=ax2["K"].transAxes,color="red",fontsize=15)
    ax2["K"].text(0.8,0.15,str(newdfK.R2devmodel4.min()),transform=ax2["K"].transAxes,color="blue",fontsize=15)
    ax2["K"].text(0.8,0.05,str(newdfK.R2devmodel5.min()),transform=ax2["K"].transAxes,color="black",fontsize=15)
    ...
    ax2["L"].title.set_text(newdfL.IdOAPN.unique()[0])
    ax2["L"].text(0.8,0.35,str(newdfL.R2devmodel1.min()),transform=ax2["L"].transAxes,color="pink",fontsize=15)
    ax2["L"].text(0.8,0.25,str(newdfL.R2devmodel2.min()),transform=ax2["L"].transAxes,color="red",fontsize=15)
    ax2["L"].text(0.8,0.15,str(newdfL.R2devmodel4.min()),transform=ax2["L"].transAxes,color="blue",fontsize=15)
    ax2["L"].text(0.8,0.05,str(newdfL.R2devmodel5.min()),transform=ax2["L"].transAxes,color="black",fontsize=15)
    ...
    ax2["M"].title.set_text(newdfM.IdOAPN.unique()[0])
    ax2["M"].text(0.8,0.35,str(newdfM.R2devmodel1.min()),transform=ax2["M"].transAxes,color="pink",fontsize=15)
    ax2["M"].text(0.8,0.25,str(newdfM.R2devmodel2.min()),transform=ax2["M"].transAxes,color="red",fontsize=15)
    ax2["M"].text(0.8,0.15,str(newdfM.R2devmodel4.min()),transform=ax2["M"].transAxes,color="blue",fontsize=15)
    ax2["M"].text(0.8,0.05,str(newdfM.R2devmodel5.min()),transform=ax2["M"].transAxes,color="black",fontsize=15)
    ...
    ax2["N"].title.set_text(newdfN.IdOAPN.unique()[0])
    ax2["N"].text(0.8,0.35,str(newdfN.R2devmodel1.min()),transform=ax2["N"].transAxes,color="pink",fontsize=15)
    ax2["N"].text(0.8,0.25,str(newdfN.R2devmodel2.min()),transform=ax2["N"].transAxes,color="red",fontsize=15)
    ax2["N"].text(0.8,0.15,str(newdfN.R2devmodel4.min()),transform=ax2["N"].transAxes,color="blue",fontsize=15)
    ax2["N"].text(0.8,0.05,str(newdfN.R2devmodel5.min()),transform=ax2["N"].transAxes,color="black",fontsize=15)
    ...
    ax2["O"].title.set_text(newdfO.IdOAPN.unique()[0])
    ax2["O"].text(0.8,0.35,str(newdfO.R2devmodel1.min()),transform=ax2["O"].transAxes,color="pink",fontsize=15)
    ax2["O"].text(0.8,0.25,str(newdfO.R2devmodel2.min()),transform=ax2["O"].transAxes,color="red",fontsize=15)
    ax2["O"].text(0.8,0.15,str(newdfO.R2devmodel4.min()),transform=ax2["O"].transAxes,color="blue",fontsize=15)
    ax2["O"].text(0.8,0.05,str(newdfO.R2devmodel5.min()),transform=ax2["O"].transAxes,color="black",fontsize=15)
    ...
    ax2["P"].title.set_text(newdfP.IdOAPN.unique()[0])
    ax2["P"].text(0.8,0.35,str(newdfP.R2devmodel1.min()),transform=ax2["P"].transAxes,color="pink",fontsize=15)
    ax2["P"].text(0.8,0.25,str(newdfP.R2devmodel2.min()),transform=ax2["P"].transAxes,color="red",fontsize=15)
    ax2["P"].text(0.8,0.15,str(newdfP.R2devmodel4.min()),transform=ax2["P"].transAxes,color="blue",fontsize=15)
    ax2["P"].text(0.8,0.05,str(newdfP.R2devmodel5.min()),transform=ax2["P"].transAxes,color="black",fontsize=15)

...
if __name__== "__main__":
    ...
    ax2["A"].loglog(newdfA.Visitantes,newdfA.yhatturistas_total,"o",color="black",label="INE")
    ...
    ax2["B"].loglog(newdfB.Visitantes,newdfB.yhatturistas_total,"o",color="black")
    ...
    ax2["C"].loglog(newdfC.Visitantes,newdfC.yhatturistas_total,"o",color="black")
    ...
    ax2["D"].loglog(newdfC.Visitantes,newdfC.yhatturistas_total,"o",color="black")
    ...
    ax2["E"].loglog(newdfE.Visitantes,newdfE.yhatturistas_total,"o",color="black")
    ...
    ax2["F"].loglog(newdfF.Visitantes,newdfF.yhatturistas_total,"o",color="black")
    ...
    ax2["G"].loglog(newdfG.Visitantes,newdfG.yhatturistas_total,"o",color="black")
    ...
    ax2["H"].loglog(newdfH.Visitantes,newdfH.yhatturistas_total,"o",color="black")
    ...
    ax2["I"].loglog(newdfI.Visitantes,newdfI.yhatturistas_total,"o",color="black")
    ...
    ax2["J"].loglog(newdfJ.Visitantes,newdfJ.yhatturistas_total,"o",color="black")
    ...
    ax2["K"].loglog(newdfK.Visitantes,newdfK.yhatturistas_total,"o",color="black")
    ...
    ax2["L"].loglog(newdfL.Visitantes,newdfL.yhatturistas_total,"o",color="black")
    ...
    ax2["M"].loglog(newdfM.Visitantes,newdfM.yhatturistas_total,"o",color="black")
    ...
    ax2["N"].loglog(newdfN.Visitantes,newdfN.yhatturistas_total,"o",color="black")
    ...
    ax2["O"].loglog(newdfO.Visitantes,newdfO.yhatturistas_total,"o",color="black")
    ...
    ax2["P"].loglog(newdfP.Visitantes,newdfP.yhatturistas_total,"o",color="black")

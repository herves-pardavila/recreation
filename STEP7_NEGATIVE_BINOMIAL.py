...
if __name__== "__main__":
    ...
    #poisson model
    expr1="""Visitantes ~ IdOAPN + Season + covid"""
    expr2="""Visitantes ~ turistas_total+ IdOAPN + Season + covid"""
    expr3="""Visitantes ~ logIUD + IdOAPN + Season + covid"""
    ...
    print(summary_as_df)
    #summary_as_df.to_csv("/home/usuario/Documentos/recreation/imagenes_paper/tabla_modelo1.csv")

...
if __name__== "__main__":
    path=r"F:/doctorado/"
    #load the data
    df=pd.read_csv(path+"recreation/ZonalTravelCost/datos_provinciales/3travel_cost_Cabañeros.csv")
    #df=df[df.Año==2019]
    print(df)
    ...
    newdf.to_csv(path+"recreation/ZonalTravelCost/datos_provinciales/3travel_cost_Cabañeros_ready.csv",index=False)
